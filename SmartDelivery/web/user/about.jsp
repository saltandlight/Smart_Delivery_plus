      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="/SmartDelivery/index.jsp">Home</a></span> <span>About us</span></p>
             ...
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="d-flex">
	              ...
	              <ul class="list-unstyled">
	                ...
	                <li><a href="login.jsp" class="py-2 d-block">Contact</a></li>
	              </ul>
	            </div>
            </div>
          </div>
