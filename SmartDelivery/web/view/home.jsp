...
<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/open-iconic-bootstrap.min.css">
<link rel="stylesheet" href="/SmartDelivery/view/user/css/animate.css">

<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/owl.carousel.min.css">
<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/owl.theme.default.min.css">
<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/magnific-popup.css">

<link rel="stylesheet" href="/SmartDelivery/view/user/css/aos.css">

<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/ionicons.min.css">

<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/bootstrap-datepicker.css">
<link rel="stylesheet"
	href="/SmartDelivery/view/user/css/jquery.timepicker.css">
...
<body class="goto-here">
	...
	<nav
		...
		id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="customermain.del">Vegefoods</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="productlist.del"
						class="nav-link">Shop</a></li>
					<li class="nav-item"><a href="customerabout.del"
						class="nav-link">About</a></li>
					<li class="nav-item"><a href="customerjoin.del"
						class="nav-link">SignUp</a></li>
					<li class="nav-item"><a href="customerlogin.del"
						class="nav-link">SignIn</a></li>
					<!-- 로그인한 후에만 들어갈 수 있게 해야 함  -->
					<li class="nav-item"><a href="customerdelcheck.del"
						class="nav-link">DeliveryCheck</a></li>
